  ...
  <body class="font-fjalla selection:bg-[#6c9f6c]">
    <div class="main">
      <section class="h-screen relative w-full">
        <nav
          class="fixed w-full z-10 top-0 justify-center flex items-center h-32 bg-transparent"
        >
          <div
            style="
          ...
          >
            ...
            <div class="sections text-lg hidden lg:flex gap-x-6 font-thin">
              <div class="flex relative group items-center">
                ...
                ></div>
                <a
                  class="py-2 px-3 transition-all ease text-black no-underline duration-500 group-hover:bg-[#6c9f6c] rounded-xl group-hover:rounded-3xl"
                  href="#"
                  >Services</a
                >
              </div>
              <div class="flex relative group items-center">
                ...
                ></div>
                <a
                  class="py-2 px-3 transition-all ease duration-500 text-black no-underline group-hover:bg-[#6c9f6c] rounded-xl group-hover:rounded-3xl"
                  href="#"
                  >About</a
                >
              </div>
            ...
            <div
              class="menu_search lg:hidden flex gap-x-3 bg-[#6c9f6c] px-4 rounded-3xl py-2"
            >
              <button id="shake" class="">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="ionicon size-5"
                  viewBox="0 0 512 512"
                >
                  <path
            ...
            <form
              class="lg:flex relative hidden bg-slate-200 overflow-hidden rounded-md"
            >
              <input
                id="srch1"
                type="search"
              ...
              <button
                type="button"
                id="srch-exp"
                class="bg-[#6c9f6c] p-3 px-4 items-center justify-center flex"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="ionicon size-4"
                  viewBox="0 0 512 512"
                >
                  <path
                    d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z"
        ...
        <video
          ...
          class="w-full h-full object-cover object-center block lg:hidden"
          muted
          autoplay
          loop
        >
        ...
        <div
          id="mysidebar"
          class="fixed z-20 top-0 -right-1/2 w-1/2 h-full block lg:hidden"
        >
          <main
            style="
          ...
          >
            ...
            >
              <svg
                id="cut"
                xmlns="http://www.w3.org/2000/svg"
                class="ionicon size-8 m-4 text-slate-200 mix-blend-exclusion"
                viewBox="0 0 512 512"
              >
                <path
                  fill="none"
      ...
      <section class="h-full w-full">
        <slider
          aria-label="Primary"
          class="flex h-[65px] lg:h-[80px] w-full items-center bg-[#6c9f6c]"
        >
          <a
            href="index.html"
